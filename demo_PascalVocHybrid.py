...
args = SimpleNamespace(batch_size=1,
                       input_dim=448,
                       # pretrained_weights="path_to_Hybrid_ViT_imagenet.pth", ##  weights can be found in supplementary material folder
                       pretrained_weights="stored_weights/Hybrid_ViT_pascal.pth", ## weights can be found in supplementary material folder
                       epochs=20,
                       lr=5e-3,
                       weight_decay=1e-4, 
