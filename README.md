...
## Experiments
To produce the results of Tables 2 and 3 referring to the ViT-base interpretability run demo.py

To produce the results of Table 4 referring to the ViT-Hybrid run demo_PascalVocHybrid.py 

To produce the results of Table 4 referring to the Affinity ViT-Hybrid run demo_PascalVocHybrid_Affinity.py 
